...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <Plug>(github-complete-manual-completion) =github_complete#manual_complete()
...
nnoremap ,h :edit ~/.vimplus/help.md
...
imap  <Plug>Isurround
inoremap <silent> ,t  :TagbarToggle
inoremap <silent> ,n  :NERDTreeToggle
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,/usr/include/tags,~/.vim/systags,~/.vim/x86_64-linux-gnu-systags
...
silent only
cd ~/hikey960_new/NanoPi_M3Pkg
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +25 Library/S5P6818Lib/pll.c
badd +58 Library/SerialPortLib/SerialPortLib.c
badd +29 Include/nx_clkgen.h
badd +227 Include/nx_s5p6818.h
argglobal
silent! argdel *
edit Library/SerialPortLib/SerialPortLib.c
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 60 - ((44 * winheight(0) + 31) / 63)
